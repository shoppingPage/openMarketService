...
| **변슬기**        |       [@seulgi626](https://github.com/seulgi626)       | 상품 상세 페이지 | 상품 상세 데이터 Fetching, 수량 변경 및 총 가격 계산 로직, 장바구니 로직, 헤더 푸터 컴포넌트 연동          |
...
- 동적 배너 구현: 상품 목록 페이지 상단 배너를 사용자의 시각적 경험을 고려한 슬라이드(Slide) 형태로 구현합니다.
